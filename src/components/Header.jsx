...
export default function Header({ user, onLoginClick, onRegisterClick, onLogoutClick, onTrackOrderClick, onCartClick, cartItemCount, onNavigate, searchQuery, onSearch, onOpenStoreClick, notifications, setNotifications }) {
