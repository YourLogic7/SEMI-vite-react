...
// Komponen untuk modal pendaftaran Affiliate (versi lengkap)
export default function AffiliateRegisterModal({ isOpen, onClose, onRegistrationSuccess, openMessageModal }) {
    ...
    const handleRegister = (e) => {
        ...
        onRegistrationSuccess(affiliateData);
        openMessageModal('Pendaftaran Berhasil', 'Pendaftaran sebagai Affiliate berhasil!');
    };
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex justify-center items-center p-4">
            <div className="bg-white rounded-lg shadow-xl w-full max-w-4xl max-h-[90vh] overflow-y-auto">
                <div className="flex justify-between items-center p-5 border-b">
                    <h3 className="text-xl font-semibold">Daftar sebagai Affiliate</h3>
                    ...
                    <form onSubmit={handleRegister}>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className="space-y-4">
                                <input name="affiliateName" type="text" placeholder="Nama Lengkap" className="w-full p-2.5 border rounded-md" required />
                            ...
                            {/* Kolom Kanan */}
                            <div className="space-y-4">
                                <h4 className="font-semibold text-slate-700">Akun Media Sosial</h4>
                                <input name="tiktok" type="text" placeholder="Username Tiktok" className="w-full p-2.5 border rounded-md" />
                                <input name="facebook" type="text" placeholder="Username Facebook" className="w-full p-2.5 border rounded-md" />
                                <input name="instagram" type="text" placeholder="Username Instagram" className="w-full p-2.5 border rounded-md" />
                                <input name="other" type="text" placeholder="Lainnya (misal: YouTube, X)" className="w-full p-2.5 border rounded-md" />
                            </div>
                        </div>
